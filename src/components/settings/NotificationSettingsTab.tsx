    ...
    const loadNotificationSettings = async () => {
      ...
      try {
        ...
        if (error && error.code !== "PGRST116" && error.code !== "406") {
          // PGRST116 = no rows found, 406 = not acceptable
        ...
        <div className="flex items-center">
          ...
          <div className="ml-3">
            ...
            <p className="text-sm text-blue-700 mt-1">
              Notification settings are being developed and will be available
              soon.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Notify when Google Sheets sync completes or fails
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleNotificationChange("errorAlerts", e.target.checked)
                }
                disabled={isSaving}
              />
              <div
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">
                When clients are added, removed, or modified
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleNotificationChange("clientChanges", e.target.checked)
                }
                disabled={isSaving}
              />
              <div
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Database changes, user actions, and system updates
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleNotificationChange("systemEvents", e.target.checked)
                }
                disabled={isSaving}
              />
              <div
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">
                When Supabase edge functions fail or timeout
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">
                When data validation fails or inconsistencies are detected
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
